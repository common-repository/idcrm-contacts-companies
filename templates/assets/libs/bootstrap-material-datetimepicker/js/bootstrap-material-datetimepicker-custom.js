(function ($, moment) {
  ...
  moment.locale(wp_datetimepicker_data.locale);
  ...
  function Plugin(element, options) {
    ...
    this.params = {
      ...
      maxDate: null,
      currentDate: null,
      lang: wp_datetimepicker_data.locale,
      weekStart: 1,
      disabledDays: [],
      shortTime: false,
      clearButton: false,
      nowButton: false,
      cancelText: wp_datetimepicker_data.cancel_text,
      okText: wp_datetimepicker_data.ok_text,
      clearText: wp_datetimepicker_data.clear_text,
      nowText: wp_datetimepicker_data.now_text,
      switchOnClick: false,
      triggerEvent: "focus",
      monthPicker: false,
      year: true,
